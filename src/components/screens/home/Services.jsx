            ...
            <div className='flex items-center gap-20 mb-10'>
                <div className='flex flex-col gap-6 items-center xl:whitespace-nowrap'>
                    ...
                    <div>
                        ...
                        <h5 className='text-center'>Free delivery for all orders over $140</h5>
                    </div>
                </div>
                <div className='flex flex-col gap-6 items-center xl:whitespace-nowrap'>
                    <div>
                    ...
                    <div>
                        ...
                        <h5 className='text-center'>Friendly 24/7 customer support</h5>
                    </div>
                </div>
                <div className='flex flex-col gap-6 items-center xl:whitespace-nowrap'>
                    <div>
                    ...
                    <div>
                        ...
                        <h5 className='text-center xl:whitespace-nowrap'>We reurn money within 30 days</h5>
                    </div>
                </div>
            </div>
        </div>

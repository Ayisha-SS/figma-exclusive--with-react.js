    ...
    <>
        <div className='py-20 px-20 wrapper max-[540px]:pt-5 md:pt-10'>
            <div className='flex justify-center items-center gap-20 max-[540px]:flex-wrap max-[540px]:gap-10 sm:gap-4 md:gap-6 min-[980px]:gap-8 lg:gap-10'>
                <div className='flex flex-col gap-6 items-center justify-center xl:whitespace-nowrap '>
                    ...
                    <div>
                        ...
                        <h5 className='text-center whitespace-nowrap sm:text-xs md:text-[14px] max-[980px]:whitespace-nowrap lg:whitespace-nowrap'>Free delivery for all orders over $140</h5>
                    </div>
                </div>
                <div className='flex flex-col gap-6 items-center xl:whitespace-nowrap '>
                    ...
                    <div>
                        ...
                        <h5 className='text-center whitespace-nowrap sm:text-xs md:text-[14px] max-[980px]:whitespace-nowrap '>Friendly 24/7 customer support</h5>
                    </div>
                </div>
                <div className='flex flex-col gap-6 items-center xl:whitespace-nowrap '>
                    <div className='w-[50%] md:w-[40%]'>
                    ...
                    <div>
                        ...
                        <h5 className='text-center whitespace-nowrap sm:text-xs md:text-[14px] max-[980px]:whitespace-nowrap xl:whitespace-nowrap'>We reurn money within 30 days</h5>
                    </div>
                </div>
            </div>
        </div>

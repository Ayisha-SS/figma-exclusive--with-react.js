...
//                             <div className='bg-[#00000014] rounded flex items-center justify-center w-[500px] h-[600px] ml-6 max-[360px]:ml-3 max-[360px]:w-[200px] max-[360px]:h-[500px] max-[480px]:ml-3 max-[540px]:w-[300px] sm:w-[400px] md:w-[500px]'>
//                                 <div className='w-[90%]'>
...
//                     <div className='flex flex-col px-12 max-[540px]:px-0 sm:px-0 md:px-0 w-[50%] max-[540px]:w-full sm:w-full md:w-full md:flex-wrap lg:flex-row'>
    ...
    <>
        <div className='py-10'>
            <div className='wrapper'>
                ...
                <div className='flex py-10 mb-12 gap-10 lg:gap-8 max-[980px]:flex-col'>
                    <div className='flex '>
                         <div className='flex flex-col gap-4 items-center justify-center'>
                             {[product.image, product.img2, product.img3, product.img4].map((image, index) => (
                                 <div
                                     key={index}
                                     className="bg-[#00000014] w-[170px] h-[138px] rounded cursor-pointer flex items-center justify-center max-[360px]:w-[110px] max-[360px]:h-[110px] max-[540px]:w-[130px] sm:w-[150px] md:w-[170px] lg:w-[130px]"
                                     onClick={() => handleImageClick(image)}
                                 >
                                     <div className='w-[50%] '>
                                         <img src={require(`../../../${image}`)} alt={`Product Image ${index}`} />
                         ...
                         <div className='md:w-full'>
                             <div className='bg-[#00000014] rounded flex items-center justify-center w-[500px] h-[600px] ml-6 max-[360px]:ml-3 max-[360px]:w-[200px] max-[360px]:h-[500px] max-[480px]:ml-3 max-[540px]:w-[300px] sm:w-[400px] md:w-[500px] lg:w-[350px]'>
                                 <div className='w-[90%]'>
                                     <img src={require(`../../../${selectedImage || product.image}`)} alt={product.name} />
                                 </div>
                             </div>
                    ...
                    <div className='flex flex-col w-[50%] max-[540px]:w-full sm:w-full md:w-full md:flex-wrap lg:flex-row'>
                        <div className='flex flex-col gap-4 '>
                            <h3 className='text-2xl leading-6 font-semibold'>{product.name}</h3>
                            <div className='flex gap-4 items-center'>
                            <span className='flex items-center'>
                        ...
                        <div className='flex flex-col gap-8 mt-8'>
                            ...
                            <div className='border-[1px] border-black rounded max-[980px]:w-[50%] max-[540px]:w-[70%] max-[480px]:w-[80%] max-[360px]:w-['>
                                <div className='flex p-4 gap-2 border-b-[1px] border-b-black'>
                                    <div>
                                        <img src={require(`../../../assests/images/icon-delivery.png`)} alt="Delivery" />
                                    </div>
